const app = Vue.createApp({
        ...
        return {
            items: [
                ...
                },
                {
                    ...
                    quantidade: 0,
                    total: 0,
                    imagem: 'Bolo Cenoura com Cobertura de Brigadeiro.jpg',
                    categoria: 'Bolo',
                    peso: '1kg'
                },
                {
                    ...
                    quantidade: 0,
                    total: 0,
                    imagem: 'Bolo Chocolate com Cobertura de Brigadeiro.jpg',
                    categoria: 'Bolo',
                    peso: '1kg'
                },
                {
                    nome: 'Bolo de Fuba com Goiabada',
                    preco: 25.00,
                    quantidade: 0,
                    total: 0,
                    imagem: 'Bolo Fuba com Goiabada.jpg',
                    categoria: 'Bolo',
                    peso: '700g'
                },
                {
                ...
                },
                {
                    ...
                    quantidade: 0,
                    total: 0,
                    imagem: 'Pudinzinho.jpg',
                    categoria: 'Pudim',
                    peso: '120g'
                },
                {
                    nome: 'Bolo de Maça Canela e Nozes',
                    preco: 20.00,
                    quantidade: 0,
                    total: 0,
                    imagem: 'Bolo de Maça Canela e Nozes.jpeg',
                    categoria: 'Bolo',
                    peso: '700g'
                },
                {
                    ...
                    quantidade: 0,
                    total: 0,
                    imagem: 'Torta de Limão.jpg',
                    categoria: 'Torta',
                    peso: '210g'
                },
                {
                    nome: 'Torta de Maracujá com Chocolate (fatia)',
                    preco: 16.00,
                    quantidade: 0,
                    total: 0,
                    imagem: 'Torta Maracuja com Chocolate.jpg',
                    categoria: 'Torta',
                    peso: '210g'
                },
                {
                ...
                },
                {
                    ...
                    quantidade: 0,
                    total: 0,
                    imagem: 'Pão de Mel.jpg',
                    categoria: 'Doces',
                    peso: '100g'
                },
                {
                    nome: 'Sanduba de Brownie',
                    preco: 10.00,
                    quantidade: 0,
                    total: 0,
                    imagem: 'Sanduba de Brownie.jpg',
                    categoria: 'Doces',
                    peso: '90g'
                },
                {
    ...
    methods: {
        ...
        calcularTotalComDesconto(subtotal, desconto, frete) {
            if (subtotal === "") {
                return NaN;
            } else {
        ...
        finalizarPedido() {
            ...
            if (produtosNoCarrinho.length > 0) {
                this.gerarPDF(produtosNoCarrinho);
                this.zerarQuantidadeNoCarrinho();
            } else {
